...
with open ('config.txt', 'r') as file:
    for line in file:
        ...
        #if theres a comma then its a tuple, the strip is to eliminate blanck spaces
        if',' in value:
...
while running:
    ...
    draw_perspective_horizontal_lines(screen, x_positions, y_curved, vanishing_point, config['line_color'])
    pygame.display.flip()
